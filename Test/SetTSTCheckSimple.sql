...
CREATE PROCEDURE SQLTest_Suite2#TestC
AS
BEGIN

   EXEC TST.Assert.LogInfo 'This is SQLTest_Suite2#TestC'
   EXEC TST.Assert.Ignore 'Ignore SQLTest_Suite2#TestC'
...
CREATE PROCEDURE SQLTest_SETUP_SuiteIgnored
AS
BEGIN
   EXEC TST.Assert.LogInfo 'This is SQLTest_SETUP_SuiteIgnored'
   EXEC TST.Assert.Ignore 'Ignore suite SuiteIgnored'
END
GO

CREATE PROCEDURE SQLTest_SuiteIgnored#TestA
AS
BEGIN
...
CREATE PROCEDURE SQLTest_SuiteIgnored#TestB
AS
BEGIN
   EXEC TST.Assert.Equals 'Test failing Assert.Equals. This line should not be executed.', 1, 2
END
