...
CALL :SubResetTSTVariable        & IF ERRORLEVEL 1 (GOTO LblExit)
...
ECHO.
ECHO IMPORTANT: 
ECHO  - TSTCheck.bat tests the integrity of the TST system.
ECHO    It can be used to validateTST itself after it was changed.
ECHO  - You do not have to use TSTCheck.bat when testing your 
ECHO    own stored procedures.
...
REM ==============================================================
REM Checks if the TST system has any variables set and if that is 
REM the case it will reset them after issuing a warning.
REM Return code: 
REM   0 - OK
REM   1 - An error/warning occured. An error message was already displayed.
REM ==============================================================
:SubResetTSTVariable

SET TC_ResetTSTVariableExitCode=0

REM If No TST database is found then simply exit the procedure.
sqlcmd %TST_SqlCmdParameters% -Q "EXIT (SELECT COUNT([name]) FROM sys.databases WHERE [name] = 'TST')" > %TC_SqlOutput% 2>&1
IF "%ERRORLEVEL%"=="0" GOTO LblResetTSTVariableDone

sqlcmd %TC_SqlCmdParameters% -d TST -Q "EXIT (SELECT COUNT(*) FROM Data.TSTVariables)" > %TC_SqlOutput% 2>&1
IF "%ERRORLEVEL%"=="0" GOTO LblResetTSTVariableDone

ECHO TSTCheck detected that your TST system has TST variables set:
ECHO.
CALL "%TC_PathToScriptFolder%TST.bat" /Get
ECHO.
ECHO - TST Variables are used for things like setting a
ECHO   custom prefix for test stored procedures. 
ECHO - TSTCheck will reset all TST variables in the process of TST validation.
ECHO   If you choose to continue, you will have to set the TST Variables 
ECHO   again after TSTCheck completes.
ECHO.

:LblAskContinue
SET /P TC_Continue=Continue? [Y/N]

IF /I "%TC_Continue%"=="Y" GOTO LblContinueWithTSTVarReset
IF /I "%TC_Continue%"=="N" GOTO LblResetTSTVariableError
GOTO LblAskContinue

:LblContinueWithTSTVarReset
CALL "%TC_PathToScriptFolder%TST.bat" /ResetAll
IF ERRORLEVEL 1 (GOTO LblResetTSTVariableError)

GOTO LblResetTSTVariableDone

:LblResetTSTVariableError
SET TC_ResetTSTVariableExitCode=1

:LblResetTSTVariableDone
EXIT /B %TC_ResetTSTVariableExitCode%
GOTO :EOF
...
SET TC_BatchTestsFailure=0

ECHO.
ECHO ===================== Validate TST.BAT script output =============
ECHO.

DEL /F /Q "%Temp%\TC_CmdOutput_*.txt" >nul 2>&1

SET TC_CommandOutput="%Temp%\TC_CmdOutput_H01.txt"
...
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

SET TC_CommandOutput="%Temp%\TC_CmdOutput_Q01.txt"
...
SET TC_CommandOutput="%Temp%\TC_CmdOutput_Q02.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunAll TSTQuickStart /NoTimestamp /XmlFormat %TC_CommandOutput% >nul 2>&1
CALL :SubValidateAgainstBaseline "Running tests in TSTQuickStart Xml" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\QuickStart.xml"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

REM ==============================================================
REM RunAll

SET TC_CommandOutput="%Temp%\TC_CmdOutput_SA01.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunAll TSTCheckSimple /NoTimestamp >%TC_CommandOutput% 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario [Failed]" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDb.txt"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

SET TC_CommandOutput="%Temp%\TC_CmdOutput_SA02.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunAll TSTCheckSimple /NoTimestamp /Verbose >%TC_CommandOutput% 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario [Failed] Verbose" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDbVerbose.txt"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

SET TC_CommandOutput="%Temp%\TC_CmdOutput_SA03.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunAll TSTCheckSimple /NoTimestamp /XmlFormat %TC_CommandOutput% >nul 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario [Failed] Xml" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDb.xml"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

SET TC_CommandOutput="%Temp%\TC_CmdOutput_SA04.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunAll TSTCheckSimple /NoTimestamp /Verbose /XmlFormat %TC_CommandOutput% >nul 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario [Failed] Xml Verbose" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDbVerbose.xml"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

REM ==============================================================
REM RunSuite Failed

SET TC_CommandOutput="%Temp%\TC_CmdOutput_SSF01.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunSuite TSTCheckSimple Suite2 /NoTimestamp >%TC_CommandOutput% 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario Suite [Failed]" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDbRunSuiteFailed.txt"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

SET TC_CommandOutput="%Temp%\TC_CmdOutput_SSF02.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunSuite TSTCheckSimple Suite2 /NoTimestamp /Verbose >%TC_CommandOutput% 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario Suite [Failed] Verbose" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDbRunSuiteFailedVerbose.txt"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

SET TC_CommandOutput="%Temp%\TC_CmdOutput_SSF03.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunSuite TSTCheckSimple Suite2 /NoTimestamp /XmlFormat %TC_CommandOutput% >nul 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario Suite [Failed] Xml" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDbRunSuiteFailed.xml"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

SET TC_CommandOutput="%Temp%\TC_CmdOutput_SSF04.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunSuite TSTCheckSimple Suite2 /NoTimestamp /Verbose /XmlFormat %TC_CommandOutput% >nul 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario Suite [Failed] Verbose Xml" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDbRunSuiteFailedVerbose.xml"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

REM ==============================================================
REM RunSuite Passed

SET TC_CommandOutput="%Temp%\TC_CmdOutput_SSP01.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunSuite TSTCheckSimple AASuite1 /NoTimestamp >%TC_CommandOutput% 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario Suite [Passed]" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDbRunSuitePassed.txt"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

SET TC_CommandOutput="%Temp%\TC_CmdOutput_SSP02.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunSuite TSTCheckSimple AASuite1 /NoTimestamp /Verbose >%TC_CommandOutput% 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario Suite [Passed] Verbose" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDbRunSuitePassedVerbose.txt"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

SET TC_CommandOutput="%Temp%\TC_CmdOutput_SSP03.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunSuite TSTCheckSimple AASuite1 /NoTimestamp /XmlFormat %TC_CommandOutput% >nul 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario Suite [Passed] Xml" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDbRunSuitePassed.xml"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

SET TC_CommandOutput="%Temp%\TC_CmdOutput_SSP04.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunSuite TSTCheckSimple AASuite1 /NoTimestamp /Verbose /XmlFormat %TC_CommandOutput% >nul 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario Suite [Passed] Verbose Xml" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDbRunSuitePassedVerbose.xml"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

REM ==============================================================
REM RunSuite Ignored

SET TC_CommandOutput="%Temp%\TC_CmdOutput_SSI01.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunSuite TSTCheckSimple SuiteIgnored /NoTimestamp >%TC_CommandOutput% 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario Suite [Ignored]" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDbRunSuiteIgnored.txt"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

SET TC_CommandOutput="%Temp%\TC_CmdOutput_SSI02.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunSuite TSTCheckSimple SuiteIgnored /NoTimestamp /Verbose >%TC_CommandOutput% 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario Suite [Ignored] Verbose" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDbRunSuiteIgnoredVerbose.txt"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

SET TC_CommandOutput="%Temp%\TC_CmdOutput_SSI03.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunSuite TSTCheckSimple SuiteIgnored /NoTimestamp /XmlFormat %TC_CommandOutput% >nul 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario Suite [Ignored] Xml" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDbRunSuiteIgnored.xml"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

SET TC_CommandOutput="%Temp%\TC_CmdOutput_SSI04.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunSuite TSTCheckSimple SuiteIgnored /NoTimestamp /Verbose /XmlFormat %TC_CommandOutput% >nul 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario Suite [Ignored] Verbose Xml" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDbRunSuiteIgnoredVerbose.xml"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

REM ==============================================================
REM RunTest Failed

SET TC_CommandOutput="%Temp%\TC_CmdOutput_STF01.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunTest TSTCheckSimple SQLTest_Suite2#TestB /NoTimestamp >%TC_CommandOutput% 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario Test [Failed]" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDbRunTestFailed.txt"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

SET TC_CommandOutput="%Temp%\TC_CmdOutput_STF02.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunTest TSTCheckSimple SQLTest_Suite2#TestB /NoTimestamp /Verbose >%TC_CommandOutput% 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario Test [Failed] Verbose" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDbRunTestFailedVerbose.txt"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

SET TC_CommandOutput="%Temp%\TC_CmdOutput_STF03.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunTest TSTCheckSimple SQLTest_Suite2#TestB /NoTimestamp /XmlFormat %TC_CommandOutput% >nul 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario Test [Failed] Xml" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDbRunTestFailed.xml"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

SET TC_CommandOutput="%Temp%\TC_CmdOutput_STF04.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunTest TSTCheckSimple SQLTest_Suite2#TestB /NoTimestamp /Verbose /XmlFormat %TC_CommandOutput% >nul 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario Test [Failed] Verbose Xml" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDbRunTestFailedVerbose.xml"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

REM ==============================================================
REM RunTest Passed

SET TC_CommandOutput="%Temp%\TC_CmdOutput_STP01.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunTest TSTCheckSimple SQLTest_Suite2#TestA /NoTimestamp >%TC_CommandOutput% 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario Test [Passed]" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDbRunTestPassed.txt"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

SET TC_CommandOutput="%Temp%\TC_CmdOutput_STP02.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunTest TSTCheckSimple SQLTest_Suite2#TestA /NoTimestamp /Verbose >%TC_CommandOutput% 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario Test [Passed] Verbose" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDbRunTestPassedVerbose.txt"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

SET TC_CommandOutput="%Temp%\TC_CmdOutput_STP03.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunTest TSTCheckSimple SQLTest_Suite2#TestA /NoTimestamp /XmlFormat %TC_CommandOutput% >nul 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario Test [Passed] Xml" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDbRunTestPassed.xml"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

SET TC_CommandOutput="%Temp%\TC_CmdOutput_STP04.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunTest TSTCheckSimple SQLTest_Suite2#TestA /NoTimestamp /Verbose /XmlFormat %TC_CommandOutput% >nul 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario Test [Passed] Verbose Xml" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDbRunTestPassedVerbose.xml"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

REM ==============================================================
REM RunTest Ignored

SET TC_CommandOutput="%Temp%\TC_CmdOutput_STI01.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunTest TSTCheckSimple SQLTest_Suite2#TestC /NoTimestamp >%TC_CommandOutput% 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario Test [Ignored]" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDbRunTestIgnored.txt"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

SET TC_CommandOutput="%Temp%\TC_CmdOutput_STI02.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunTest TSTCheckSimple SQLTest_Suite2#TestC /NoTimestamp /Verbose >%TC_CommandOutput% 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario Test [Ignored] Verbose" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDbRunTestIgnoredVerbose.txt"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

SET TC_CommandOutput="%Temp%\TC_CmdOutput_STI03.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunTest TSTCheckSimple SQLTest_Suite2#TestC /NoTimestamp /XmlFormat %TC_CommandOutput% >nul 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario Test [Ignored] Xml" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDbRunTestIgnored.xml"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)

SET TC_CommandOutput="%Temp%\TC_CmdOutput_STI04.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunTest TSTCheckSimple SQLTest_Suite2#TestC /NoTimestamp /Verbose /XmlFormat %TC_CommandOutput% >nul 2>&1
CALL :SubValidateAgainstBaseline "Simple Test Scenario Test [Ignored] Verbose Xml" %TC_CommandOutput% "%TC_PathToScriptFolder%Test\Baseline\SimpleDbRunTestIgnoredVerbose.xml"
IF ERRORLEVEL 1 (SET TC_BatchTestsFailure=1)
...
SET TC_CommandOutput="%Temp%\TC_CmdOutput_SL01.txt"
...
SET TC_CommandOutput="%Temp%\TC_CmdOutput_SL02.txt"
...
SET TC_CommandOutput="%Temp%\TC_CmdOutput_SL03.txt"
...
IF ERRORLEVEL 1 (
   ...
   TYPE %TC_SqlOutput% >&2
   SET TC_BatchTestsFailure=1
   GOTO LblAfterSessionSetupFailureOutput
)
...
SET TC_CommandOutput="%Temp%\TC_CmdOutput_SL04.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunAll TSTCheckSessionLevelOutput /NoTimestamp /Verbose >%TC_CommandOutput% 2>&1
...
SET TC_CommandOutput="%Temp%\TC_CmdOutput_SL05.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunAll TSTCheckSessionLevelOutput /NoTimestamp /Verbose /XmlFormat %TC_CommandOutput% >nul 2>&1
...
:LblAfterSessionSetupFailureOutput
...
IF ERRORLEVEL 1 (
   ...
   TYPE %TC_SqlOutput% >&2
   SET TC_BatchTestsFailure=1
   GOTO LblAfterSessionOnlyTeardownFailureOutput
)
...
SET TC_CommandOutput="%Temp%\TC_CmdOutput_SL06.txt"
...
SET TC_CommandOutput="%Temp%\TC_CmdOutput_SL07.txt"
...
:LblAfterSessionOnlyTeardownFailureOutput
...
IF ERRORLEVEL 1 (
   ...
   TYPE %TC_SqlOutput% >&2
   SET TC_BatchTestsFailure=1
   GOTO LblAfterSessionTeardownFailureOutput
)
...
SET TC_CommandOutput="%Temp%\TC_CmdOutput_SL08.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunAll TSTCheckSessionLevelOutput /NoTimestamp /Verbose >%TC_CommandOutput% 2>&1
...
SET TC_CommandOutput="%Temp%\TC_CmdOutput_SL09.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunAll TSTCheckSessionLevelOutput /NoTimestamp /Verbose /XmlFormat %TC_CommandOutput% >nul 2>&1
...
:LblAfterSessionTeardownFailureOutput
...
IF ERRORLEVEL 1 (
   ...
   TYPE %TC_SqlOutput% >&2
   SET TC_BatchTestsFailure=1
   GOTO LblAfterSessionLevelFailureOutput
)
...
SET TC_CommandOutput="%Temp%\TC_CmdOutput_SL10.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunAll TSTCheckSessionLevelOutput /NoTimestamp /Verbose >%TC_CommandOutput% 2>&1
...
SET TC_CommandOutput="%Temp%\TC_CmdOutput_SL11.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunAll TSTCheckSessionLevelOutput /NoTimestamp /Verbose /XmlFormat %TC_CommandOutput% >nul 2>&1
...
:LblAfterSessionLevelFailureOutput
...
IF ERRORLEVEL 1 (
   ...
   TYPE %TC_SqlOutput% >&2
   SET TC_BatchTestsFailure=1
   GOTO LblAfterSessionLevelErrorOutput
)
...
SET TC_CommandOutput="%Temp%\TC_CmdOutput_SL12.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunAll TSTCheckSessionLevelOutput /NoTimestamp /Verbose >%TC_CommandOutput% 2>&1
...
SET TC_CommandOutput="%Temp%\TC_CmdOutput_SL13.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunAll TSTCheckSessionLevelOutput /NoTimestamp /Verbose /XmlFormat %TC_CommandOutput% >nul 2>&1
...
:LblAfterSessionLevelErrorOutput
...
IF ERRORLEVEL 1 (
   ...
   TYPE %TC_SqlOutput% >&2
   SET TC_BatchTestsFailure=1
   GOTO LblAfterSessionLevelIgnoreOutput
)
...
SET TC_CommandOutput="%Temp%\TC_CmdOutput_SL14.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunAll TSTCheckSessionLevelOutput /NoTimestamp /Verbose >%TC_CommandOutput% 2>&1
...
SET TC_CommandOutput="%Temp%\TC_CmdOutput_SL15.txt"
CALL "%TC_PathToScriptFolder%TST.bat" /RunAll TSTCheckSessionLevelOutput /NoTimestamp /Verbose /XmlFormat %TC_CommandOutput% >nul 2>&1
...
:LblAfterSessionLevelIgnoreOutput
...
SET TC_CommandOutput="%Temp%\TC_CmdOutput_E01.txt"
...
SET TC_CommandOutput="%Temp%\TC_CmdOutput_P01.txt"
...
IF "%TC_BatchTestsFailure%"=="1" GOTO :LblBatchTestsError

GOTO LblBatchTestsDone

:LblBatchTestsError
ECHO.
ECHO Error. Some errors occurred during the validation of the TST Output.>&2
ECHO.
...
ECHO.
ECHO TSTCheck.bat will run test automation that validates the TST system.
ECHO.
